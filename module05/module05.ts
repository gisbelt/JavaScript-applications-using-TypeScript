...
// an interface can be used to ensure the form of the class instance 
// Note that the interface includes the constructor parameters, not the properties. 
interface Vehicle {
    make: string;
    color: string;
    doors: number;
...
class Car implements Vehicle {
    ...
    // Constructor
    constructor(make: string, color: string, doors = 4, code: number) {
        this._make = make;
        this._color = color;
        this._doors = doors;
        this._code = code;
...
class ElectricCar extends Car {
    ...
    // Constructor
    constructor(make: string, color: string, range: number, code: number, doors = 2) {
